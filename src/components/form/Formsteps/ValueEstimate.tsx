        ...
        formData.family.adults && (
          <>
            <h1 className="text-3xl text-center mx-auto mt-[48px] mb-[48px] font-spoof w-2/3">
              Based on your given information we estimate your house hold
              effects are worth
            </h1>
            <FormSlider
              min={10000}
            ...
            <span className="text-pink text-center w-full px-24 block m-auto text-xl">
              ...
              less. be aware that underinsuring means that the full amount
              cannot be paid out since it’s lower than the estimated value
            </span>
